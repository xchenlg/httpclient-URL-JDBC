...
public class HttpClientUtil {
    ...
    public void loginDiscuz() {
        ...
        HttpPost httpPost = new HttpPost("http://localhost:9095/api/SegApi/toSeg");
        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(20000).setConnectTimeout(20000).build();
        httpPost.setConfig(requestConfig);
        // 创建参数队列
        List<NameValuePair> formparams = new ArrayList<NameValuePair>();
        formparams.add(new BasicNameValuePair("content", "民网河内7月22日电%20(记者刘刚)%20“2016年中国广西教育展”21日在越南首都河内举行。来自中国广西的24所高校设立展台,为越南学生了解赴华留学"));
